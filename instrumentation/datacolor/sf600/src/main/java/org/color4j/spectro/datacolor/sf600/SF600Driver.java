...
import org.color4j.spectro.datacolor.common.ExtraUltraSmallAperture;
import org.color4j.spectro.datacolor.common.ExtraUltraSmallAreaView;
...
public class SF600Driver implements SpectroDriver
{
    ...
    public String getLocalizedText( String text, Locale locale )
    {
        try
        {
            return ResourceBundle.getBundle( "org.color4j.spectro.drivers.dci.Bundle", locale ).getString( text );
        }
